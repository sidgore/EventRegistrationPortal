...
public class TestEventController {
	...
	public void testDisplayEvent_Positive() {
		/**
		 * @TODO: Call displayEvent methods and assert it for appropriate model
		 *        view name
		 */
	}
	...
	public void testDisplayEvent_Negative() {
		/**
		 * @TODO: Call displayEvent methods by passing request as null and
		 *        assert it for appropriate model view name
		 */
	}
	...
	public void testUpdateEvent_Positive() {
		/**
		 * @TODO: Call updateEvent methods and assert it for appropriate model
		 *        view name
		 */
	}
	...
	public void testUpdateEvent_Negative() {
		/**
		 * @TODO: Call updateEvent methods by passing request as null and assert
	...
	public void testDeleteEvent_Positive() {
		/**
		 * @TODO: Call deleteEvent methods and assert it for appropriate model
		 *        view name
		 */
	}
	...
	public void testDeleteEvent_Negative() {
		/**
		 * @TODO: Call deleteEvent methods by passing request as null and assert
		 *        it for appropriate model view name
		 */
	}
