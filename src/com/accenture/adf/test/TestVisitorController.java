...
public class TestVisitorController {
	...
	public void testSearchEventsByName_Positive() {
		 ...
		 * @TODO: Create MockHttpServletRequest object Set visitor object in
		 *        VISITOR session by calling searchUser method from visitorDAO
		 *        Set request parameters for eventname Call searchEventsByName
		 *        method and assert model view name
		 */
	}
	...
	public void testSearchEventsByNameCatalog_Positive() {
		 ...
		 * @TODO: Create MockHttpServletRequest object Set visitor object in
		 *        VISITOR session by calling searchUser method from visitorDAO
		 *        Set request parameters for eventname Call
		 *        searchEventsByNameCatalog method and assert model view name
		 */
	}
	...
	public void testSearchEventsByName_Negative() {
		/**
		 * @TODO: Call searchEventsByName method by passing request object as
		 *        null and asserting the model view name
		 */
	}
	...
	public void testSearchEventsByNameCatalog_Negative() {
		/**
		 * @TODO: Call searchEventsByNameCatalog method by passing request
		 *        object as null and asserting the model view name
		 */
	}
	...
	public void testShowEventsAsc_Negative() {
		/**
		 * @TODO: Call showEventsAsc method by passing request object as null
		 *        and asserting the model view name
		 */
	}
	...
	public void testShowEventsDesc_Negative() {
		/**
		 * @TODO: Call showEventsDesc method by passing request object as null
		 *        and asserting the model view name
		 */
	}
	...
	public void testShowEventsCatalogAsc_Negative() {
		/**
		 * @TODO: Call showEventsCatalogAsc method by passing request object as
		 *        null and asserting the model view name
		 */
	}
	...
	public void testShowEventsCatalogDesc_Negative() {
		/**
		 * @TODO: Call showEventsCatalogDesc method by passing request object as
		 *        null and asserting the model view name
		 */
	}
	 ...
	 */
	/*
	 * @Test public void testChangePassword_Positive(){
	 *//**
		 * @TODO: Create MockHttpServletRequest object Set visitor object in
		 *        VISITOR session by calling searchUser method from visitorDAO
		 *        Set request parameters for password Call changePassword method
		 *        and assert status as success
		 */
	/*
	 * }
	 * 
	 *//**
		 ...
		 */
	/*
	 * @Test public void testChangePassword_PasswordNull(){
	 *//**
		 * @TODO: Create MockHttpServletRequest object Set visitor object in
		 *        VISITOR session by calling searchUser method from visitorDAO
		 *        Do not set request parameters for password Call changePassword
		 *        method and assert status as success
		 */
	/*
	 * }
	 * 
	 *//**
		 ...
		 */
	/*
	 * @Test public void testChangePassword_VisitorNull(){
	 *//**
		 * @TODO: Create MockHttpServletRequest object Do not set visitor object
		 *        in VISITOR session by calling searchUser method from
		 *        visitorDAO Set request parameters for password Call
		 *        changePassword method and assert status as success
		 *//*
		 * }
		 */
