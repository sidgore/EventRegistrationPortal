...
public class TestVisitorServiceImpl {
	...
	public void testCreateVisitor() {
		/**
		 * @TODO: Set the appropriate values for visitor object and call the
		 *        method createVisitor by passing an argument of this visitor
	...
	public void testSearchVisitor() {
		 ...
		 *        and then asserting the returned type visitor username with the
		 *        argument passed
		 */
	}
	...
	public void testRegisterVisitor() {
		 ...
		 *        can be retrieved using searchVisitor method and then asserting
		 *        the returned type of RegisterVisitor method
		 */
	}
	...
	public void testShowRegisteredEvents() {
		/**
		 * @TODO: Call showRegisteredEvents method by passing visitor object
		 *        which can be retrieved using searchVisitor method and then
		 *        asserting the returned type of showRegisteredEvents method
		 */
	}
	...
	public void testUpdateVisitorDetails() {
		/**
		 * @TODO: Call updateVisitorDetails method by passing the visitor object
		 *        which can be retrieved using searchVisitor method and then
		 *        asserting the returned type of updateVisitorDetails
		 */
	}
	...
	public void testUnregisterEvent() {
		/**
		 * @TODO: Call unregisterEvent method by passing the visitor object
		 *        which can be retrieved using searchVisitor method and then
		 *        asserting the returned type of unregisterEvent
		 */
	}
